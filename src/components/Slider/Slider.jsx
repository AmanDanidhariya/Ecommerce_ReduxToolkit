...
const Slider = () => {
  ...
  return (
    <div className="relative pb-4">
      ...
      <div>
        <button
          className="absolute top-[50%] left-4 bg-white rounded-full p-2 hover:bg-gray-400"
        ...
        <button
          className="absolute top-[50%] right-4 bg-white rounded-full p-2 hover:bg-gray-400"
